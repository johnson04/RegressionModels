<h3>Automatic or Manual Transmissions - Which is Better?</h3>
<h6>Chuan Zhang</h6>
...
```{r Figure1, fig.height=3, fig.width=3}
...
```{r Figure2, fig.height=3.5, fig.width=3.5}
...
```{r Figure3, fig.height=3, fig.width=3}
mycol = rainbow(2)
